...
func createAtivoHandlerHandler(
	...
	service := service.NewAtivoInformacaoService(repo, cotacaoRepo, valuationRepo, ativoEndividamentoService, ativoEficienciaService, ativoRentabilidadeService, ativoDividendoService)
