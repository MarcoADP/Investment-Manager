...
func ToCarteiraAtivo(carteiraId uint, ativoRequest request.CarteiraAtivoRequest) *model.CarteiraAtivo {
	return model.NewCarteiraAtivo(carteiraId, ativoRequest.Codigo, ativoRequest.ProporcaoDesejada, ativoRequest.Movimento)
}
...
func ToCarteiraAtivoResponse(ativo model.CarteiraAtivo, consolidacao model.Consolidacao, cotacao model.CotacaoHistorico) response.CarteiraAtivoResponse {
	return response.NewCarteiraAtivoResponse(ativo.ID, ativo.Codigo, ativo.ProporcaoDesejada, ativo.Movimento, consolidacao, cotacao)
}

func ToCarteiraAtivoSimpleResponse(ativo model.CarteiraAtivo) response.CarteiraAtivoResponse {
	return response.NewCarteiraAtivoResponse(ativo.ID, ativo.Codigo, ativo.ProporcaoDesejada, ativo.Movimento, model.Consolidacao{}, *&model.CotacaoHistorico{})
}
